...
#ifndef __NOXIMTILEPLUS_H__
#define __NOXIMTILEPLUS_H__
...
*/
	...
	// Instances
    NoximRouterPlus *r;		                // Router instance
    NoximProcessingElement *pe;	                // Processing Element instance

    // Constructor
	int i;
    SC_CTOR(NoximTilePlus) {
	
	// Router pin assignments
	r = new NoximRouterPlus("Router");
	r->clock(clock);
	r->reset(reset);
